  ...
  methods:{
    ...
    lotteryStart(){
      ...
      that.lotteryStartFun=setInterval(function(){
        ...
        if(that.lotteryNum>(that.peopleList.length-that.lotteryLength)*80){
          that.lotteryNum=0
        }
    ...
    lotteryStop(){
      ...
      let endNum=(Math.ceil(that.lotteryNum/80)+10)*80
      let cha=endNum%((that.peopleList.length-that.lotteryLength)*80)
